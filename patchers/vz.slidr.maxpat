...
,
		...
		"enablevscroll" : 0,
		"devicewidth" : 0.0,
		"description" : "Smear a video",
		"digest" : "",
		"tags" : "Vizzie Effect, slidr",
		"style" : "",
		"subpatcher_template" : "",
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 560.5, 621.5, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 471.0, 645.5, 60.0, 22.0 ],
					"text" : "zl.change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 471.0, 621.5, 84.0, 22.0 ],
					"text" : "routepass dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 216.0, 493.0, 57.0, 22.0 ],
					"text" : "t getdim l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.0, 711.5, 279.0, 22.0 ],
					"text" : "jit.gl.texture @adapt 0 @type char @dim 1280 720"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.609558, 355.771027000000004, 46.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.474807977676392, 16.0, 46.0, 21.0 ],
					"text" : "SLIDR",
...
, 			{
				"box" : 				{
					...
					"hint" : "Set the value for the slide up control.",
					"id" : "obj-21",
					"ignoreclick" : 1,
					...
					"patching_rect" : [ 413.0, 168.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the value for the slide down control.",
					"id" : "obj-28",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 547.0, 171.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 514.0, 365.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 64.474807739257813, 49.0, 55.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 380.0, 365.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.12872314453125, 49.0, 55.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 30 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 483.0, 92.0, 22.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 292.0, 621.5, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 216.0, 583.0, 225.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 216.0, 456.0, 41.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the value for the slide down control.",
					"id" : "obj-30",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Set the value for the slide up control.",
					"id" : "obj-31",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 430.0, 87.0, 23.0 ],
					"text" : "slide_down $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 430.0, 72.0, 23.0 ],
					"text" : "slide_up $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 782.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 389.5, 537.5, 225.5, 537.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 424.0, 158.0, 422.0, 158.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 558.0, 159.5, 556.0, 159.5 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 225.5, 612.75, 301.5, 612.75 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.5, 663.5, 465.75, 663.5, 465.75, 572.0, 431.5, 572.0 ],
					"source" : [ "obj-7", 0 ]
				}
