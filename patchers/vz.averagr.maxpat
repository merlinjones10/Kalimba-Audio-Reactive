...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 469.0, 54.0, 23.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hint" : "The AVERAGR module provides a way to tame wildly fluctuating input data by applying a variable average weighting to its output. At low smoothing values, the current input value will be favored, while high input values will smooth the data over the entire input history, providing gentle ouput curves.",
					"id" : "obj-34",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.609558, 335.993011000000024, 71.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 16.0, 71.0, 21.0 ],
					"text" : "AVERAGR",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 521.0, 113.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 253.0, 163.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 432.0, 518.407501000000025, 112.0, 84.0 ],
...
, 			{
				"box" : 				{
					...
					"hint" : "Set the amount of smoothing applied to the data input.",
					"id" : "obj-37",
					"maxclass" : "live.dial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 27.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 487.0, 289.993011000000024, 36.0, 24.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 513.0, 334.993011000000024, 49.0, 24.0 ],
					"text" : "* 0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 467.0, 365.993011000000024, 65.0, 24.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 467.0, 335.993011000000024, 49.0, 24.0 ],
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 487.0, 55.5, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 531.0, 95.25, 530.0, 95.25 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 496.5, 257.993011000000024, 552.5, 257.993011000000024 ],
					"order" : 0,
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 214.833333333333314, 343.0, 180.5, 343.0 ],
					"order" : 2,
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 238.166666666666657, 152.0, 262.0, 152.0 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 214.833333333333314, 343.0, 263.5, 343.0 ],
					"order" : 1,
					"source" : [ "obj-50", 1 ]
				}
