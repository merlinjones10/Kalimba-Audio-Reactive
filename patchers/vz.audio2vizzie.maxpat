...
, 			{
				"box" : 				{
					...
					"fontname" : "Ableton Sans Bold Regular",
					"fontsize" : 12.0,
					"hint" : "The AUDIO2VIZZIE module takes standard audio input and converts is into Vizzie-standard video and data outputs. Audio inputs will map the signal range to a 0-255 char data range and apply that to the R, G, and B planes of the output video. The data ouputs scale the audio output to Vizzie's standard 0. - 1.0 output range.",
					"id" : "obj-22",
					"legacytextcolor" : 1,
					"maxclass" : "textbutton",
					"mode" : 1,
